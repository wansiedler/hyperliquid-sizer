...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=wansiedler_hyperliquid-sizer&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=wansiedler_hyperliquid-sizer)
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=wansiedler_hyperliquid-sizer&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=wansiedler_hyperliquid-sizer)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=wansiedler_hyperliquid-sizer&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=wansiedler_hyperliquid-sizer)
[![Reliability Rating](https://sonarcloud.io/api/project_badges/measure?project=wansiedler_hyperliquid-sizer&metric=reliability_rating)](https://sonarcloud.io/summary/new_code?id=wansiedler_hyperliquid-sizer)
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=wansiedler_hyperliquid-sizer&metric=bugs)](https://sonarcloud.io/summary/new_code?id=wansiedler_hyperliquid-sizer)
[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=wansiedler_hyperliquid-sizer&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=wansiedler_hyperliquid-sizer)
[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=wansiedler_hyperliquid-sizer&metric=code_smells)](https://sonarcloud.io/project/issues?id=wansiedler_hyperliquid-sizer&issueStatuses=OPEN)
[![Duplicated Lines (%)](https://sonarcloud.io/api/project_badges/measure?project=wansiedler_hyperliquid-sizer&metric=duplicated_lines_density)](https://sonarcloud.io/component_measures?id=wansiedler_hyperliquid-sizer&metric=duplicated_lines_density)
[![Technical Debt](https://sonarcloud.io/api/project_badges/measure?project=wansiedler_hyperliquid-sizer&metric=sqale_index)](https://sonarcloud.io/component_measures?id=wansiedler_hyperliquid-sizer&metric=sqale_index)
[![Lines of Code](https://sonarcloud.io/api/project_badges/measure?project=wansiedler_hyperliquid-sizer&metric=ncloc)](https://sonarcloud.io/component_measures?id=wansiedler_hyperliquid-sizer&metric=ncloc)
